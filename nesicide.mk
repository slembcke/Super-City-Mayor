...
### ggj20 or modify the custom rules
...
# Default: none
CFLAGS  = -t nes  -g --debug-info -Oirs --register-space 16  -I ext/pixler/lib
...
# Default: none
ASFLAGS = -t nes  -g --debug-info   -I ext/pixler/lib
...
# Default: none
LDFLAGS = -t nes -C $(CONFIG)  -Wl --dbgfile,GGJ20.dbg
REMOVES += GGJ20.dbg
...
PROGRAM = $(PRGDIR)/GGJ20.prg

# Set SOURCES to something like 'src/foo.c src/bar.s'.
SOURCES := src/main.c
SOURCES += src/data.s src/misc.s audio/audio.s audio/sounds.s ext/famitone2/famitone2.s
SOURCES += 
...
$(PROGRAM): $(CONFIG) $(OBJECTS) $(LIBS)
	$(LINK) $(LDFLAGS) $(OBJECTS) $(LIBS) -o $@ ext/pixler/lib/px.lib
